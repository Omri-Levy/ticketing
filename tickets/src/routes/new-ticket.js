...
var ticket_created_publisher_1 = __importDefault(require("../events/publishers/ticket-created-publisher"));
var nats_wrapper_1 = require("../nats-wrapper");
var newTicket = express_1.Router();
newTicket.post("/api/tickets", common_1.requireAuth, [
    ...
    var _a, title, price, ticket, publisher;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.sent();
                publisher = new ticket_created_publisher_1.default(nats_wrapper_1.natsWrapper.stan);
                publisher.publish({
                    id: ticket.id,
                    title: ticket.title,
                    price: ticket.price,
