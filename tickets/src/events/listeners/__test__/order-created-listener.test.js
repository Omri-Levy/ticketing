...
var order_created_listener_1 = __importDefault(require("../order-created-listener"));
var setup = function () { return __awaiter(void 0, void 0, void 0, function () {
    var listener, ticket, data, msg;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                listener = new order_created_listener_1.default(nats_wrapper_1.natsWrapper.stan);
            ...
            case 1:
                _a.sent();
                data = {
                    id: genFakeMongoId_1.default(),
                    version: 0,
                    status: common_1.OrderStatus.CREATED,
                    userId: genFakeMongoId_1.default(),
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    expect(updatedTicket === null || updatedTicket === void 0 ? void 0 : updatedTicket.orderId).toBe(data.id);
                    return [2 /*return*/];
            }
        });
    }); });
